Java锁---偏向锁、轻量级锁、自旋锁、重量级锁 - linghu_java - 博客园
...
<img width="820" height="269" src="../_resources/83c208d327604367911a934122a34ad3.png"/>
...
![这里写图片描述](../_resources/7e291836da5c4ab19d4e695372c734ac.png)
...
<img width="820" height="91" src="../_resources/45658fc095254dcfb9f1c4b56d5b5548.png"/>
...
1.  在代码进入同步块的时候，如果同步对象锁状态为无锁状态（锁标志位为“01”状态，是否为偏向锁为“0”），虚拟机首先将在当前线程的栈帧中建立一个名为锁记录（Lock Record）的空间，用于存储锁对象目前的Mark Word的拷贝，官方称之为 Displaced Mark Word。这时候线程堆栈与对象头的状态如图：   
    　　<img width="780" height="369" src="../_resources/0bcea61902594b1497229b35871f0ff1.jpg"/>所示。
...
4.  如果这个更新动作成功了，那么这个线程就拥有了该对象的锁，并且对象Mark Word的锁标志位设置为“00”，即表示此对象处于轻量级锁定状态，这时候线程堆栈与对象头的状态如图所示。   
    　　<img width="780" height="523" src="../_resources/e1cc83d4f4d04431b4aa7df81e9bdd8e.jpg"/>
...
<img width="820" height="387" src="../_resources/d01b3055907c42ca86e92b32cafa25d9.jpg"/>
